...
return xr} ) .call(this,options.precedence) ,parse_associates_right=hash( /* unary , node */options.right.split( /\s+/ ) ) ,parse_lr=hash( /* unary , node */options.binary.split( /\s+/ ) ) ,parse_r=hash(options.prefix|| [ 'u+' , 'u-' , 'u!' , 'u~' , 'u++' , 'u--' , 'new' , 'typeof' , 'finally' , 'case' , 'var' , 'const' , 'void' , 'delete' ] )parse_l=hash(options.postfix|| [ '--' , '++' ] ) ,parse_invocation=hash(options.invocation|| [ '()' , '[]' ] ) ,parse_r_optional=hash(options.r_optional|| [ 'return' , 'throw' , 'break' , 'continue' , 'else' ] ) ,parse_ambiguous_group=hash(options.ambiguous_group|| [ '(' , '[' ] ) ,parse_block=hash(options.block|| [ ';' , '{' ] ) ,parse_ternary=hash(options.ternary|| [ /* unary , node */ '?' ] ) ,parse_not_a_value=hash(options.not_a_value|| [ 'function' , 'if' , 'for' , 'while' , 'catch' , 'void' , 'delete' , 'new' , 'typeof' , 'in' , 'instanceof' ] ) ,parse_also_expression=hash(options.also_expression|| [ /* unary , node */ 'function' ] ) ,parse_index_forward= (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
...
for(var k_b_W4$uHZCokOxsoESCeUSF1i in xs)if(Object.prototype.hasOwnProperty.call(xs,k_b_W4$uHZCokOxsoESCeUSF1i) )x=xs[k_b_W4$uHZCokOxsoESCeUSF1i] ,xr[k_b_W4$uHZCokOxsoESCeUSF1i] = ( +x) ;
...
var xr=new xs.constructor() ;
for(var k_b_W4$uHZCokOxsoESCeUSF1i in xs)if(Object.prototype.hasOwnProperty.call(xs,k_b_W4$uHZCokOxsoESCeUSF1i) )x=xs[k_b_W4$uHZCokOxsoESCeUSF1i] ,xr[k_b_W4$uHZCokOxsoESCeUSF1i] = ( +x) ;
return xr} ) .call(this, { 'function' : '2' , 'if' : '1' , 'do' : '1' , 'catch' : '1' , 'try' : '1' , 'for' : '1' , 'while' : '1' , 'with' : '1' , 'switch' : '1' } ) ,parse_group=options.group|| { '(' : ')' , '[' : ']' , '{' : '}' , '?' : ':' } ;
return( { /* unary , node */lex_op= (function(it) {return(hash(it) ) } ) .call(this, ( (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push.apply(xr,Array.prototype.slice.call( (x.split( /\s+/ ) ) ) ) ;
return xr} ) .call(this,options.precedence) ) ) ,parse_reduce_order= (function(xs) {var x,x0,xi,xl,xr;
...
xi<xl;
 ++xi)x=xs[xi] ,xr.push( (hash( /* unary , node */x.split( /\s+/ ) ) ) ) ;
return xr} ) .call(this,options.precedence) ,parse_associates_right=hash( /* unary , node */options.right.split( /\s+/ ) ) ,parse_lr=hash( /* unary , node */options.binary.split( /\s+/ ) ) ,parse_r=hash(options.prefix|| [ 'u+' , 'u-' , 'u!' , 'u~' , 'u++' , 'u--' , 'new' , 'typeof' , 'finally' , 'case' , 'var' , 'const' , 'void' , 'delete' ] ) :lex_op= (function(it) {return(hash(it) ) } ) .call(this, ( (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push.apply(xr,Array.prototype.slice.call( (x.split( /\s+/ ) ) ) ) ;
return xr} ) .call(this,options.precedence) ) ) ,parse_reduce_order= (function(xs) {var x,x0,xi,xl,xr;
...
xi<xl;
 ++xi)x=xs[xi] ,xr.push( (hash( /* unary , node */x.split( /\s+/ ) ) ) ) ;
return xr} ) .call(this,options.precedence) ,parse_associates_right=hash( /* unary , node */options.right.split( /\s+/ ) ) ,parse_lr=hash( /* unary , node */options.binary.split( /\s+/ ) ) ,parse_r=hash(options.prefix|| [ 'u+' , 'u-' , 'u!' , 'u~' , 'u++' , 'u--' , 'new' , 'typeof' , 'finally' , 'case' , 'var' , 'const' , 'void' , 'delete' ] ) } ) } ) .call(this) } ,bindings_for=function( /* unary , node */options) {;
return $.merge( { } , (function(xs) {var x,x0,xi,xl,xr;
var xr=new xs.constructor() ;
for(var k_b_W4$uHZCokOxsoESCeUSF1i in xs)if(Object.prototype.hasOwnProperty.call(xs,k_b_W4$uHZCokOxsoESCeUSF1i) )x=xs[k_b_W4$uHZCokOxsoESCeUSF1i] ,xr[k_b_W4$uHZCokOxsoESCeUSF1i] = ( (lex_table) .call( {x0:x0,xi:xi,xl:xl,xs:xs,xr:xr} ,x) ) ;
return xr} ) .call(this,$.merge( { } ,default_tables,options.tables) ) , (function(xs) {var x,x0,xi,xl,xr;
var xr=new xs.constructor() ;
for(var k_b_W4$uHZCokOxsoESCeUSF1i in xs)if(Object.prototype.hasOwnProperty.call(xs,k_b_W4$uHZCokOxsoESCeUSF1i) )x=xs[k_b_W4$uHZCokOxsoESCeUSF1i] ,xr[k_b_W4$uHZCokOxsoESCeUSF1i] = (x.charCodeAt(0) ) ;
